...
MDX ingest/render pipeline과 Public Article API는 다음 티켓에서 추가합니다.
...
DATABASE_URL='postgresql://seojing@localhost:5432/seojing_backend?schema=public' pnpm prisma:migrate:dev
